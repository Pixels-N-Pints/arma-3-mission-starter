...
force ace_medical_deathChance = 0.502539;
...
// AUS - ACE Unconscious Spectator
AUS_allow3PPCamera = true;
AUS_allowAi = false;
AUS_allowFreeCamera = false;
AUS_MaxDistance = "30";
AUS_MaxHeight = "30";
AUS_ShowCameraButtons = true;
AUS_ShowControlsHelper = true;
AUS_ShowFocusInfo = true;
AUS_ShowHeader = true;
AUS_ShowLists = true;
AUS_SpecType = 0;
AUS_Whitelist = false;
...
force TFAR_setting_defaultFrequencies_lr_west = "40,41,42,43,44";
force TFAR_setting_defaultFrequencies_sr_east = "";
force TFAR_setting_defaultFrequencies_sr_independent = "";
force TFAR_setting_defaultFrequencies_sr_west = "50,51,52,53,54";
